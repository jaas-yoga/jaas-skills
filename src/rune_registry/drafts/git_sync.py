...
from rune_registry.authn.github_client import GitHubApiClient, GitHubPullRequest, GitHubRelease
...
def parse_github_repo_url(url: str) -> tuple[str, str]:
    ...
    if not match:
        raise RuneError(ErrorCode.SCHEMA_VALIDATION_FAILED, f"not a GitHub repo URL: '{url}'")
