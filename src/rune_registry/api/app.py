...
from rune_registry.api import observability_routes
from rune_registry.api.account_routes import router as account_router
from rune_registry.api.auth_routes import router as auth_router
from rune_registry.api.draft_routes import router as draft_router
from rune_registry.api.errors import register_error_handlers
from rune_registry.api.github_routes import router as github_router
from rune_registry.api.guardrail_routes import router as guardrail_router
from rune_registry.api.middleware import ObservabilityMiddleware
from rune_registry.api.release_routes import router as release_router
from rune_registry.api.routes import router
from rune_registry.api.tenant_routes import router as tenant_router
from rune_registry.artifact.tokens import ArtifactTokenIssuer
from rune_registry.artifact.trust import TrustPolicy
from rune_registry.authn.ci_credentials import GitHubOidcVerifier
from rune_registry.authn.github_client import GitHubApiClient, HttpGitHubApiClient
from rune_registry.authn.github_connections import GitHubConnectionStore
from rune_registry.authn.github_oauth_apps import GitHubOAuthAppStore
...
from rune_registry.authz.base import AllowAllAuthorizer, Authorizer
from rune_registry.common.config import Settings
from rune_registry.drafts.store import DraftStore
from rune_registry.guardrails.client import GuardrailsClient, HttpGuardrailsClient
from rune_registry.guardrails.custom_rules import CustomGuardrailRuleStore
from rune_registry.guardrails.policy import GuardrailPolicyStore
...
def create_app(
    *,
    ...
    # design.md §4.5: the standalone rune-guardrails service — a separate
