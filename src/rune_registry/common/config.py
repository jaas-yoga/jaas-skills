...
class FeatureFlags(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="RUNE_FEATURE_")
...
class Settings(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="RUNE_", env_file=".env", extra="ignore")
    ...
    jwt_issuer: str = "rune-registry-dev"
    jwt_audience: str = "rune-registry"
    ...
    # codebase/process (see the rune-guardrails-catalog repo), never
    # imported in-process. RUNE_GUARDRAILS_SERVICE_URL overrides for
    ...
    release_oidc_audience: str = "rune-registry"
