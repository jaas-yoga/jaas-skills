"""HTTP client for the standalone jaas-guardrails service
(https://github.com/balakrishna-maduru/jaas-guardrails-catalog). This is
...
from jaas_registry.validation.models import DependencyDeclaration, ManifestDocument
