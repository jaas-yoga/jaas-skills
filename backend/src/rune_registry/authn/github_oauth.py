...
_STATE_AUDIENCE = "rune-github-oauth-state"
...
def verify_state(state: str, *, secret: str, issuer: str) -> GitHubOAuthState:
    """Raises RuneError(INVALID_GITHUB_STATE) on any signature/expiry/
    ...
    try:
        ...
        raise RuneError(ErrorCode.INVALID_GITHUB_STATE, f"invalid OAuth state: {exc}") from exc
