...
from rune_registry.common.audit import StructuredLogAuditSink, new_custom_guardrail_rule_event
...
def put_custom_guardrail_rule(
    ...
    if error is not None:
        raise RuneError(ErrorCode.INVALID_CUSTOM_GUARDRAIL, error)
...
def delete_repo_link(
    ...
    if not found:
        raise RuneError(ErrorCode.REPO_LINK_NOT_FOUND, f"no repo link for skill id '{skill_id}'")
