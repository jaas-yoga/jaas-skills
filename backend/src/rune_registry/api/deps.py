...
from rune_registry.authn.google import GoogleIdentityVerifier, RealGoogleIdentityVerifier
...
def get_guardrail_catalog(request: Request) -> list[GuardrailDefinition]:
    ...
    request actually needs it (raises RuneError(GUARDRAILS_SERVICE_UNAVAILABLE)
