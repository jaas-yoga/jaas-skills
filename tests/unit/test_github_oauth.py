...
from jaas_registry.authn.github_oauth import (
...
class TestSignAndVerifyState:
    ...
    def test_rejects_wrong_secret(self):
        ...
        with pytest.raises(JaasError, match="invalid OAuth state"):
    ...
    def test_rejects_a_session_token_reused_as_state(self):
        ...
        session_shaped_payload = {
            ...
            "tenant": "tnt_1",
            "iss": ISSUER,
            "aud": "jaas-registry",  # session token audience, not oauth-state
            "iat": now,
            "exp": now + 300,
        }
    ...
    def test_rejects_state_missing_tenant_id(self):
        ...
        with pytest.raises(JaasError, match="missing tenant_id"):
